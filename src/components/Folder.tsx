...
const Folder = (props: FolderProps) => {
    ...
    return (
            ...
            <Window windowTitle={props.windowTitle}>
                <div className='border-y-[1px]  px-4 flex mb-[2px] justify-between border-[#222]'>
                    <span className='w-4 whitespace-nowrap'>{children.length} items</span>
                    <h1 className='flex justi'>616K in disk</h1>
                    <h2 className='w-4 whitespace-nowrap relative right-[108px] text-end'>50K in available</h2>
                </div>
